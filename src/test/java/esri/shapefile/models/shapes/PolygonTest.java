...
public class PolygonTest {
    ...
    public void testBuildingFromBytes() throws Exception {
        ...
        byteBuffer.putInt(5); // Shape Type
        ...
        final Polygon polygon = Polygon.fromBytes(byteBuffer.array());
        assertEquals(5,   polygon.getShapeType());
        assertEquals(1.1, polygon.getXMin(), 0.001);
        assertEquals(9.8, polygon.getYMin(), 0.001);
        assertEquals(1.2, polygon.getXMax(), 0.001);
        assertEquals(9.9, polygon.getYMax(), 0.001);
